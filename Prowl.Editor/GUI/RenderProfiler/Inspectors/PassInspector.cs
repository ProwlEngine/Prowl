...
public sealed class ProfilerPassInspector
{
    ...
    public void Draw(Paper paper, ProfiledView? view, ProfiledPass? pass, IProfilerHistory history, ISnapshotResourceResolver? resolver)
    {
        ...
        using (paper.Column("rdp_pass_viewer").Height(UnitValue.Auto).ColBetween(InspectorKit.SectionGap).Enter())
        {
            ...
            if (resolver != null && _selectedResource is { } selected)
            {
    ...
    private static void DrawTextureAttachments(Paper paper, string id, ResourceRef resource, ISnapshotResourceResolver? resolver)
    {
        ...
        for (int i = 0; i < version.Subtextures.Count; i++)
            TextureViewer.Create(paper, $"{id}_attach{i}", version.Subtextures[i].Name).Show();
    }
    ...
    {
        InspectorKit.DrawLineChart(paper, "rdp_pv_objects_chart", "Objects", "Count", InspectorKit.FormatCountCompact, UnitValue.Stretch(), InspectorKit.ChartHeight, true,
    ...
    {
        InspectorKit.DrawLineChart(paper, "rdp_pv_geometry_chart", "Geometry", "Count", InspectorKit.FormatCountCompact, UnitValue.Stretch(), InspectorKit.ChartHeight, true,
    ...
    {
        InspectorKit.DrawLineChart(paper, "rdp_pv_rendering_chart", "Rendering", "Count", InspectorKit.FormatCountCompact, UnitValue.Stretch(), InspectorKit.ChartHeight, true,
    ...
    {
        InspectorKit.DrawLineChart(paper, "rdp_pv_pixelproc_chart", "Pixel Processing", "Count", InspectorKit.FormatCountCompact, UnitValue.Stretch(), InspectorKit.ChartHeight, false,
    ...
    {
        InspectorKit.DrawLineChart(paper, "rdp_pv_pipelinestate_chart", "Pipeline State", "Count", InspectorKit.FormatCountCompact, UnitValue.Stretch(), InspectorKit.ChartHeight, true,
