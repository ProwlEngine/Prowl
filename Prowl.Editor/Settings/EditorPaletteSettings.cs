...
/// </summary>
[ProjectSettings("Editor Palettes", EditorIcons.Palette, order: 5)]
public class EditorPaletteSettings : ProjectSettingsBase
{
    ...
    {
        EditorGUI.Header(paper, "pal_hdr", $"{EditorIcons.Palette}  Editor Palettes");
        EditorGUI.Separator(paper, "pal_sep");
        EditorGUI.Label(paper, "pal_info", $"Colors: {ColorPalette.Count}  |  Curves: {CurvePalette.Count}");
    }
