...
public static class PlayerSettingsFiles
{
    ...
    public const string NavMeshAgentTypes = "NavMeshAgentTypeSettings";
    public const string NavMeshAreas = "NavMeshAreaSettings";
    ...
    /// </summary>
    public static IReadOnlyList<string> All => [Physics, Audio, Time, Assets, TagsAndLayers, NavMeshAgentTypes, NavMeshAreas];
}
