...
internal struct BepuPoseIntegratorCallbacks : IPoseIntegratorCallbacks
{
    ...
    public BepuPoseIntegratorCallbacks()
    {
    }
    ...
    public void PrepareForIntegration(float dt)
    {
        ...
        _linearDampingDt = new Vector<float>((float)MathD.Pow(MathHelper.Clamp(1 - LinearDamping, 0, 1), dt));
        _angularDampingDt = new Vector<float>((float)MathD.Pow(MathHelper.Clamp(1 - AngularDamping, 0, 1), dt));
