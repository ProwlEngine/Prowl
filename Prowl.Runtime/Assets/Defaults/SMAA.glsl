// -----------------------------------------------------------------------------
// SMAA (Subpixel Morphological Anti-Aliasing) — reference implementation.
//
// This is the upstream SMAA.hlsl from https://github.com/iryoku/smaa, included
