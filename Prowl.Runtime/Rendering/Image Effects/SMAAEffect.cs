...
public sealed class SMAAEffect : ImageEffect
{
    ...
    public override void OnRenderEffect(RenderContext context)
    {
        ...
        var edgesRT = RenderTexture.GetTemporaryRT(w, h, false, [TextureImageFormat.Color4b]);
        ...
        cmd.Blit(context.SceneColor, edgesRT, _mat, 0, clearColor: true);

        // Pass 1: blend weight calculation (reads edges as _MainTex + Area/Search LUTs).
        cmd.Blit(edgesRT, blendRT, _mat, 1, clearColor: true);
