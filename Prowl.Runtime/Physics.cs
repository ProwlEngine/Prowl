...
namespace Prowl.Runtime
{
    public static class Physics
    {
        ...
        private static double physicsTimer = 0;
        ...
        public static void Update()
        {
            ...
            var targetTimestepDuration = Time.fixedDeltaTime;
            while (physicsTimer >= targetTimestepDuration)
            {
                Simulation.Timestep((float)targetTimestepDuration, ThreadDispatcher);
                SceneManager.PhysicsUpdate();
                physicsTimer -= targetTimestepDuration;
            }
        }
