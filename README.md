...
1. Clone the repo with the command `git clone --recurse-submodules https://github.com/ProwlEngine/Prowl.git`
   or `git clone --recurse-submodule git@github.com:ProwlEngine/Prowl.git` (in case you prefer SSH)
